        ...
        public async Task<ActionResult> Register(RegisterViewModel model, string role)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        studentNumber = Request.Form["AlumniId"];
                    }
                    ...
                    if (role == "student")
                    {
                        return RedirectToAction("Create", "Students", new { userId = user.Id });
                    }
                    else if (role == "alumni")
                    {
                        return RedirectToAction("Create", "Alumni", new { userId = user.Id });
                    }
