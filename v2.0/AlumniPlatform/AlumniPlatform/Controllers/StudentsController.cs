...
public class StudentsController : Controller
{
    ...
    public ActionResult DeleteConfirmed(string id)
    {
        ...
        // 删除相关导师关系
        var mentorships = db.Mentorships.Where(m => m.Student.Id == id).ToList();
        db.Mentorships.RemoveRange(mentorships);

        // 删除相关活动参与记录
        var eventAttendances = db.EventAttendances.Where(e => e.User.Id == id).ToList();
        db.EventAttendances.RemoveRange(eventAttendances);
